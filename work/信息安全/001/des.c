...
int main()
{
  ...
  block64ToBlock8(block64, encodedBlock8);
  printf("%s\n", encodedBlock8);
  */
  ...
  des8_t testString2[] = "12345678";
  des8_t testString3[] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0};
  block8ToBlock64(testString2, block64);
  block64ToBlock8(block64, block8);
  // memcpy(block8, testString, 8);
